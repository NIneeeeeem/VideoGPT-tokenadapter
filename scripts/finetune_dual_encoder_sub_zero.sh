...
# PRETRAIN_VIDEO_MLP_PATH=.cache/mlp2x_gelu_internvideo2/mm_projector.bin
# PRETRAIN_IMAGE_MLP_PATH=.cache/mlp2x_gelu_clip_l14_336px/mm_projector.bin
OUTPUT_DIR_PATH=results/videogpt_plus_finetune_sub_zero

deepspeed --include localhost:${GPUS} --master_port 35380 videogpt_plus/train/train.py \
