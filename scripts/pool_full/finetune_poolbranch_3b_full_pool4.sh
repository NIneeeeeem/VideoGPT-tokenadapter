...
BASE_LLM_PATH=.cache/qwen2_5/3b_instruction
...
PRETRAIN_VIDEO_MLP_PATH=path/to/video_mm_projector.bin 
PRETRAIN_IMAGE_MLP_PATH=path/to/image_mm_projector.bin
# 输出权重位置，用于后续测试
OUTPUT_DIR_PATH=results/pool_full/finetune_qwen3b_poolbranch_pool4
